...
class PlanDayExerciseCreate(SQLModel):
    #payload para criar associação entre dia do plano e exercicio
    plan_day_id: str
    exercise_id: str
...
class PlanDayExerciseUpdate(SQLModel):
    #payload para atualizar associação entre dia do plano e exercicio
...
class PlanDayExerciseRead(SQLModel):
    #modelo para leitura de associação entre dia do plano e exercicio
    id: str
    plan_day_id: str
    exercise_id: str
    sets: int
