...
- [PT Manager — Backend API](#pt-manager--backend-api)
  ...
  - [Authentication \& Authorization](#authentication--authorization)
    - [JWT Flow](#jwt-flow)
    - [Roles](#roles)
    - [Subscription-Gated Access](#subscription-gated-access)
  - [Subscription System](#subscription-system)
    - [Subscription Status Flow](#subscription-status-flow)
  - [Stripe Integration](#stripe-integration)
    - [Trainer Registration Flow](#trainer-registration-flow)
    - [Webhooks Handled](#webhooks-handled)
    - [Automatic Tier Management](#automatic-tier-management)
  - [Background Jobs](#background-jobs)
  - [Testing](#testing)
    - [Test Structure](#test-structure)
  - [Deployment](#deployment)
    - [Render.com (Production)](#rendercom-production)
